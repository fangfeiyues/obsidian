...
-  **Partition 可容错网络分区**
	...
	当出现网络分区（如某个节点故障、丢包、中断、拥塞等）后，系统依旧能继续履行服务
...
- **Redis**
	...
	AP。默认异步复制，当主节点异常，还可响应请求但从节点不一定能读到最新数据，Cluster 哨兵监控下线故障节点，最终一致性优先


-  **Zookeeper**
  
	CP。通过 Zab 协议，当主节点异常，会暂停服务进行 Leader 选举，此时无法响应请求
...
-  **HBase**
	...
	CP。基于HDFS多副本存储，通过Zookeeper协调故障转移